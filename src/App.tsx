...
const PRESETS: Preset[] = [
  ...
  {
    name: 'NOISE FX',
    description: 'Noise through filter with reverb',
    emoji: '⋈',
    modules: [
  ...
  {
    name: 'ECHO PAD',
    description: 'Warm pad with delay repeats',
    emoji: '♪',
    modules: [
      { id: 'vco1', type: 'vco1', x: 24, y: 24 },
    ...
    cables: [
      ...
      { id: 'c2', fromJackId: 'delay1_wet_out', toJackId: 'reverb1_in', color: '#fb923c' },
      { id: 'c3', fromJackId: 'reverb1_dry_out', toJackId: 'output1_l_in', color: '#34d399' },
      { id: 'c4', fromJackId: 'reverb1_wet_out', toJackId: 'output1_r_in', color: '#a78bfa' },
    ],
  },
  {
    name: 'SEQ BASS',
    description: 'Sequencer drives bass with ADSR shaping',
    emoji: '⊏',
    modules: [
    ...
    cables: [
      ...
      { id: 'c6', fromJackId: 'vcf1_out', toJackId: 'output1_l_in', color: '#4ade80' },
      { id: 'c7', fromJackId: 'vcf1_out', toJackId: 'output1_r_in', color: '#4ade80' },
    ],
  },
  {
    name: 'DUAL DRIFT',
    description: 'Two detuned oscillators with modulated filter',
    emoji: '◈◈',
    modules: [
      { id: 'vco1', type: 'vco1', x: 24, y: 24 },
      { id: 'vco2', type: 'vco2', x: 260, y: 24 },
      { id: 'lfo1', type: 'lfo', x: 500, y: 24 },
      { id: 'vcf1', type: 'vcf', x: 24, y: 320 },
      { id: 'mixer1', type: 'mixer', x: 260, y: 320 },
      { id: 'reverb1', type: 'reverb', x: 500, y: 320 },
      { id: 'output1', type: 'output', x: 24, y: 620 },
    ],
    cables: [
      ...
      { id: 'c3', fromJackId: 'mixer1_out', toJackId: 'vcf1_in', color: '#fbbf24' },
      { id: 'c4', fromJackId: 'lfo1_out', toJackId: 'vcf1_cv_in', color: '#38bdf8' },
      { id: 'c5', fromJackId: 'vcf1_out', toJackId: 'reverb1_in', color: '#4ade80' },
      { id: 'c6', fromJackId: 'reverb1_dry_out', toJackId: 'output1_l_in', color: '#34d399' },
      { id: 'c7', fromJackId: 'reverb1_wet_out', toJackId: 'output1_r_in', color: '#a78bfa' },
    ],
  },
  {
    name: 'RHYTHM TAP',
    description: 'Sequencer gates noise through filter and delay',
    emoji: '🎯',
    modules: [
      { id: 'seq1', type: 'seq', x: 24, y: 24 },
      { id: 'noise1', type: 'noise', x: 260, y: 24 },
      { id: 'lfo1', type: 'lfo', x: 500, y: 24 },
      { id: 'vcf1', type: 'vcf', x: 24, y: 320 },
      { id: 'vca1', type: 'vca', x: 260, y: 320 },
      { id: 'delay1', type: 'delay', x: 500, y: 320 },
      { id: 'output1', type: 'output', x: 24, y: 620 },
    ],
    cables: [
      { id: 'c1', fromJackId: 'noise1_out', toJackId: 'vcf1_in', color: '#e2e8f0' },
      { id: 'c2', fromJackId: 'lfo1_out', toJackId: 'vcf1_cv_in', color: '#38bdf8' },
      { id: 'c3', fromJackId: 'vcf1_out', toJackId: 'vca1_in', color: '#4ade80' },
      { id: 'c4', fromJackId: 'seq1_gate_out', toJackId: 'vca1_cv_in', color: '#fbbf24' },
      { id: 'c5', fromJackId: 'vca1_out', toJackId: 'delay1_in', color: '#f472b6' },
      { id: 'c6', fromJackId: 'delay1_dry_out', toJackId: 'output1_l_in', color: '#60a5fa' },
      { id: 'c7', fromJackId: 'delay1_wet_out', toJackId: 'output1_r_in', color: '#fb923c' },
    ],
  },
  {
    name: 'LUSH SYNTH',
    description: 'Two VCOs blended with complex modulation and reverb',
    emoji: '🌊',
    modules: [
      { id: 'vco1', type: 'vco1', x: 24, y: 24 },
      { id: 'vco2', type: 'vco2', x: 260, y: 24 },
      { id: 'lfo1', type: 'lfo', x: 500, y: 24 },
      { id: 'mixer1', type: 'mixer', x: 24, y: 320 },
      { id: 'vcf1', type: 'vcf', x: 260, y: 320 },
      { id: 'delay1', type: 'delay', x: 500, y: 320 },
      { id: 'reverb1', type: 'reverb', x: 24, y: 620 },
      { id: 'output1', type: 'output', x: 260, y: 620 },
    ],
    cables: [
      { id: 'c1', fromJackId: 'vco1_out', toJackId: 'mixer1_ch1_in', color: '#ff9500' },
      { id: 'c2', fromJackId: 'vco2_out', toJackId: 'mixer1_ch2_in', color: '#fb923c' },
      { id: 'c3', fromJackId: 'mixer1_out', toJackId: 'vcf1_in', color: '#fbbf24' },
      { id: 'c4', fromJackId: 'lfo1_out', toJackId: 'vcf1_cv_in', color: '#38bdf8' },
      { id: 'c5', fromJackId: 'vcf1_out', toJackId: 'delay1_in', color: '#4ade80' },
      { id: 'c6', fromJackId: 'delay1_wet_out', toJackId: 'reverb1_in', color: '#fb923c' },
      { id: 'c7', fromJackId: 'reverb1_dry_out', toJackId: 'output1_l_in', color: '#34d399' },
      { id: 'c8', fromJackId: 'reverb1_wet_out', toJackId: 'output1_r_in', color: '#a78bfa' },
    ],
  },
  {
    name: 'AMBIENT FOG',
    description: 'Slow filtered noise with deep reverb and delay',
    emoji: '☁️',
    modules: [
      { id: 'noise1', type: 'noise', x: 24, y: 24 },
      { id: 'lfo1', type: 'lfo', x: 260, y: 24 },
      { id: 'vcf1', type: 'vcf', x: 500, y: 24 },
      { id: 'delay1', type: 'delay', x: 24, y: 320 },
      { id: 'reverb1', type: 'reverb', x: 260, y: 320 },
      { id: 'output1', type: 'output', x: 500, y: 320 },
    ],
    cables: [
      { id: 'c1', fromJackId: 'noise1_out', toJackId: 'vcf1_in', color: '#e2e8f0' },
      { id: 'c2', fromJackId: 'lfo1_out', toJackId: 'vcf1_cv_in', color: '#38bdf8' },
      { id: 'c3', fromJackId: 'vcf1_out', toJackId: 'delay1_in', color: '#4ade80' },
      { id: 'c4', fromJackId: 'delay1_dry_out', toJackId: 'reverb1_in', color: '#60a5fa' },
      { id: 'c5', fromJackId: 'delay1_wet_out', toJackId: 'reverb1_in', color: '#fb923c' },
      { id: 'c6', fromJackId: 'reverb1_dry_out', toJackId: 'output1_l_in', color: '#34d399' },
      { id: 'c7', fromJackId: 'reverb1_wet_out', toJackId: 'output1_r_in', color: '#a78bfa' },
    ],
  },
  {
    name: 'PERC HIT',
    description: 'Percussive attack from sequencer gated noise burst',
    emoji: '⚡',
    modules: [
      { id: 'seq1', type: 'seq', x: 24, y: 24 },
      { id: 'noise1', type: 'noise', x: 260, y: 24 },
