...
const PRESETS: Preset[] = [
  ...
  {
    name: 'KEYBOARD 8-BIT',
    description: 'Dual oscillators filtered with keyboard - rich 8-bit tones',
    emoji: '8️⃣🎹',
    modules: [
      { id: 'keyboard1', type: 'keyboard', x: 24, y: 24 },
      { id: 'vco1', type: 'vco1', x: 260, y: 24 },
    ...
    cables: [
      ...
      { id: 'c3', fromJackId: 'keyboard1_gate_out', toJackId: 'adsr1_gate_in', color: '#fbbf24' },
      { id: 'c4', fromJackId: 'vco1_out', toJackId: 'mixer1_ch1_in', color: '#ff9500' },
      { id: 'c5', fromJackId: 'vco2_out', toJackId: 'mixer1_ch2_in', color: '#fb923c' },
      { id: 'c6', fromJackId: 'mixer1_out', toJackId: 'vcf1_in', color: '#fbbf24' },
      { id: 'c7', fromJackId: 'lfo1_out', toJackId: 'vcf1_cv_in', color: '#38bdf8' },
  ...
  {
    name: 'KEYBOARD SWEEP',
    description: 'Keyboard with LFO-modulated filter sweep',
    emoji: '🎹◈',
    modules: [
      { id: 'keyboard1', type: 'keyboard', x: 24, y: 24 },
      { id: 'vco1', type: 'vco1', x: 260, y: 24 },
    ...
    cables: [
      ...
      { id: 'c5', fromJackId: 'vcf1_out', toJackId: 'vca1_in', color: '#4ade80' },
      { id: 'c6', fromJackId: 'adsr1_env_out', toJackId: 'vca1_cv_in', color: '#a78bfa' },
      { id: 'c7', fromJackId: 'vca1_out', toJackId: 'output1_l_in', color: '#f472b6' },
      { id: 'c8', fromJackId: 'vca1_out', toJackId: 'output1_r_in', color: '#f472b6' },
    ],
  },
  {
    name: 'KEYBOARD + REVERB',
    description: 'Keyboard with atmospheric reverb tail',
    emoji: '🎹☁',
    modules: [
      { id: 'keyboard1', type: 'keyboard', x: 24, y: 24 },
      { id: 'vco1', type: 'vco1', x: 260, y: 24 },
    ...
    cables: [
      ...
      { id: 'c3', fromJackId: 'vco1_out', toJackId: 'vca1_in', color: '#ff9500' },
      { id: 'c4', fromJackId: 'adsr1_env_out', toJackId: 'vca1_cv_in', color: '#a78bfa' },
      { id: 'c5', fromJackId: 'vca1_out', toJackId: 'reverb1_in', color: '#f472b6' },
